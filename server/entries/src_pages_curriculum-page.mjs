...
import "react";
import { I as InfoPage, s as sidebar, D as DefinitionList } from "../chunks/chunk-1f1a0bb6.js";
import "prop-types";
import "../chunks/chunk-869567f0.js";
...
const Page = (props) => {
  return /* @__PURE__ */ jsxs(
    InfoPage,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("section", { className: "subsection", children: [
          /* @__PURE__ */ jsx("h3", { className: "subsection-title", children: "Class Structure" }),
          /* @__PURE__ */ jsx("p", { children: "Our classes are generally divided into the following phases. Some classes deviate slightly from this paradigm in order to focus on special curricula (especially when a visiting instructor is present), but, in general, each class tends to follow this pattern." }),
          /* @__PURE__ */ jsx("p", { children: "Classes always begin and end with a traditional salute, which is a pattern that clearly demarcates the beginning and ending of class and acts as a 'contract' between instructor and student that both will pay attention and exercise discipline during the class." }),
          /* @__PURE__ */ jsx(DefinitionList, { terms: classPhases, definitions: classPhaseDefinitions })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "subsection", children: [
          /* @__PURE__ */ jsx("h3", { className: "subsection-title", children: "Lesson Syllabus" }),
          /* @__PURE__ */ jsx("p", { children: "Our lessons in Kung Fu consist of several subjects which make up our overall curriculum. In a single class, a lesson may cover several of these topics, or it may cover a single topic in more depth. A brief description of the different topic categories is below." }),
          /* @__PURE__ */ jsx(DefinitionList, { terms: lessonTopics, definitions: lessonTopicDefinitions })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "subsection", children: [
          /* @__PURE__ */ jsx("h3", { className: "subsection-title", children: "Self-Study Expectations" }),
          /* @__PURE__ */ jsx("p", { children: "In addition to class attendance, students are expected to spend time conditioning themselves outside of class. As students progress further in the ranks, this requirement becomes more crucial to success. While each student may require a different amount of time for different concepts, students should strive to practice 2 hours per week outside of class for every hour of class in which they participate." }),
          /* @__PURE__ */ jsx("p", { children: "The following is a list of items each student should practice on their own, outside of class:" }),
          /* @__PURE__ */ jsxs("ul", { children: [
            /* @__PURE__ */ jsx("li", { children: "Stance Training" }),
            /* @__PURE__ */ jsx("li", { children: "Practice and Review of Known Forms" }),
            /* @__PURE__ */ jsx("li", { children: "Journaling/Memory Retention Techniques" }),
            /* @__PURE__ */ jsx("li", { children: "Meditation and Chi Kung Visualizations" }),
            /* @__PURE__ */ jsx("li", { children: "Conditioning Drills" }),
            /* @__PURE__ */ jsx("li", { children: "Sparring Review/Self-Critique" })
          ] })
        ] })
      ]
    }

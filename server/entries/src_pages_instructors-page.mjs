...
const ProfileAvatar$1 = "";
const ProfileAvatar = ({ ...props }) => {
  return /* @__PURE__ */ jsx("div", { className: "avatar-frame large-avatar", children: /* @__PURE__ */ jsx("img", { className: "avatar-image", src: props.image, alt: props.name }) });
};
...
const InstructorProfile = ({ ...props }) => {
  ...
  if (props.roles) {
    props.roles.forEach((title, index) => {
      ...
      titles.push(/* @__PURE__ */ jsx("h4", { className: "instructor-profile-title", children: title }, key));
    });
  }
  let bioParagraphs = [];
  if (props.biography) {
    props.biography.forEach((bioPara, index) => {
      ...
      bioParagraphs.push(/* @__PURE__ */ jsx("p", { children: bioPara }, key));
    });
  }
  return /* @__PURE__ */ jsxs("div", { className: "instructor-profile", children: [
    /* @__PURE__ */ jsx(ProfileAvatar, { image: props.image, name: props.name }),
    /* @__PURE__ */ jsxs("div", { className: "instructor-profile-text", children: [
      /* @__PURE__ */ jsxs("h3", { className: "instructor-profile-name", children: [
        props.title && `${props.title} `,
        props.name
      ] }),
      /* @__PURE__ */ jsx("div", { className: "instructor-profile-titles", children: titles }),
      /* @__PURE__ */ jsx("div", { className: "instructor-profile-bio", children: bioParagraphs })
    ] })
  ] });
};
    ...
    InfoPage,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("section", { className: "subsection", children: [
          /* @__PURE__ */ jsx("h3", { children: "Staff Member Category Definitions" }),
          /* @__PURE__ */ jsx("p", { children: "At the Sinking Moon School of Kung Fu, we have several different categories of staff member, depending on how active a given individual is in the day-to-day activities surrounding the organization." }),
          /* @__PURE__ */ jsx(DefinitionList, { terms, definitions })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "subsection", children: [
          /* @__PURE__ */ jsx("h2", { className: "subsection-title", children: "Current Instructors" }),
          /* @__PURE__ */ jsx(
            InstructorProfile,
            {
              name: "Scott Johnson",
